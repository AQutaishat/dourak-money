        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PayoutOrderMethod = table.Column<int>(type: "integer", nullable: true),
                    PayoutOrderConfirmed = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cycles_CircleMembers_RecipientMemberId",
                        column: x => x.RecipientMemberId,
                        principalTable: "CircleMembers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Cycles_Circles_CircleId",
                        column: x => x.CircleId,
                        principalTable: "Circles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PayoutPositions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PayoutPositions_CircleMembers_MemberId",
                        column: x => x.MemberId,
                        principalTable: "CircleMembers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PayoutPositions_Circles_CircleId",
                        column: x => x.CircleId,
                        principalTable: "Circles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payouts_CircleMembers_RecipientMemberId",
                        column: x => x.RecipientMemberId,
                        principalTable: "CircleMembers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Payouts_Cycles_CycleId",
                        column: x => x.CycleId,
                        principalTable: "Cycles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Circles_OrganizerUserId",
                table: "Circles",
                column: "OrganizerUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Contributions_CycleId_MemberId",
                table: "Contributions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cycles_CircleId_SequenceNumber",
                table: "Cycles",
                columns: new[] { "CircleId", "SequenceNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Cycles_RecipientMemberId",
                table: "Cycles",
                column: "RecipientMemberId");

            migrationBuilder.CreateIndex(
                name: "IX_PayoutPositions_CircleId_MemberId",
                table: "PayoutPositions",
                columns: new[] { "CircleId", "MemberId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PayoutPositions_CircleId_Position",
                table: "PayoutPositions",
                columns: new[] { "CircleId", "Position" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PayoutPositions_MemberId",
                table: "PayoutPositions",
                column: "MemberId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payouts_RecipientMemberId",
                table: "Payouts",
                column: "RecipientMemberId");
        }
